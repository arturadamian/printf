 ...
 */
typedef	int (*op_func)(va_list, char *, char *);
...
int op_print_number(va_list valist, char *flag_str, char *len_mods_str);
int op_print_binary(va_list valist, char *flag_str, char *len_mods_str);
int op_print_unsigned(va_list valist, char *flag_str, char *len_mods_str);
int op_print_octal(va_list valist, char *flag_str, char *len_mods_str);
